...
CREATE TABLE `applications` (
  ...
  CONSTRAINT `applications_ibfk_1` FOREIGN KEY (`contract_id`) REFERENCES `contracts` (`id`),
...
CREATE TABLE `contracts` (
  ...
  CONSTRAINT `contracts_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`)
...
INSERT INTO `students` VALUES (1,'Прокофьев','Владислав','Артёмович'),(2,'Степанов','Алексей','Григорьевич'),(3,'Мезенев','Григорий','Викторович'),(4,'Самойленко','Алексей','Олегович'),(5,'Ленивцев','Олег','Андреевич'),(12,'Корюков','Иван','Николаевич');
...
-- Dump completed on 2016-04-28 17:38:35
